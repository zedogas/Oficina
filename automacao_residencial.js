...
function AlteraRele3(){
    ...
    if(estado_3 === "0"){
        ...
        document.getElementById("botao_3").innerHTML="<a href='/?2_ligar' class='botao_3'>Liga</a>";
    }
}
function AlteraRele4(){
    var estado_4 = document.getElementById("estado_2").innerHTML;
    if(estado_4 === "0"){
        ...
        document.getElementById("botao_4").innerHTML="<a href='/?2_ligar' class='botao_4'>Liga</a>";
